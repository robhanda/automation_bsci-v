...
def creatingcommands():
	...
	for i in range(0,bcf):
			...
			cmd3=cmd3.replace("\r\n","")
        		...
        		#print cmd3
       			cmd.append(cmd3)
		        #cmd3= "LT_SET BIN ELG 0 /home/gprs3gemulator-5.5.10-corr1/bcf /root/gte/profile/ps.conf /root/gte/profile/dt_test.tcl 0 NULL NULL"
			cmd3= "LT_SET BIN ELG"+" " + str(i)+" "+ str(gemu_path)+"/bcf"+ " /root/gte/profile/gprs.conf /root/gte/profile/gprs_test.tcl"+" " +str(i)+" " +  "NULL NULL"
		        cmd3=cmd3.replace("\r\n","")
			...
			cmd2=cmd2.replace("\r\n","")
        		...
        		#print cmd2
      		  	cmd.append(cmd2)
        		cmd3= "LT_SET BIN ELG"+" " + str(i)+" "+ str(gemu_path)+"/bcf_"+str(i)+ " /root/gte/profile/gprs.conf /root/gte/profile/gprs_test.tcl"+" " +str(i)+" " +  "NULL NULL"
